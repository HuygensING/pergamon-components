...
const Suggestions: React.SFC = (props) =>
	...
	>
		...
		/>
		<p>Generating semantic suggestions for better search results.</p>
		<p>The ePistolarium has found 9 terms that are used in the same context. You can add them to improve your search results:</p>
		<ul
			style={{
				listStyle: 'none',
				margin: '.5em 0 0 0',
