...
export const NotImplemented: Tag = (props) =>
	...
	>
        ...
        This tag is not part of the Huygens ING TEI standard. Please visit <a style={{
			color: '#fff',
		}}
             href="http://servicedesk.huygens.knaw.nl" target="_blank">Servicedesk.huygens.knaw.nl</a> to request support of this tag.
        </div>
	</div>
